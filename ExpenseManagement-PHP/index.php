          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="static/how.html"> How </a>
                </li>
                <!-- <li class="nav-item">
                  <a class="nav-link" href="#">
                    <span>Wallet</span> <img src="static/images/wallet.png" alt="" />
                  </a>
                </li> -->
                <li class="nav-item">
                  <a class="nav-link" href="login01.php"> Login</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="templates\2-sign-up.php"> Sign Up</a>
                </li>
              </ul>
            ...
            <div class="container">
              <div class="box">
                <div class="row">
                  ...
                  <div class="col-md-5">
                    <div class="img-box">
                      <img src="static\images\Expense-management-best-pactices.webp" alt="" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="how_container">
      <div class="box">
        ...
        <div class="detail-box">
          ...
          <p>
            Management Finance is the study of financial decision-making within organizations, focusing on capital budgeting, working capital management, and financial planning to maximize shareholder value.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="detail-box">
          ...
          <p>
            A budget is a comprehensive financial plan that guides an organization's resource allocation, cost control, 
            and decision-making to achieve its objectives.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="detail-box">
          ...
          <p>
          The system should provide users with comprehensive reports that 
          summarize their spending across different categories, time periods, and payment methods. This could include reports on total expenses, 
          monthly/yearly trends, top spending categories, and more.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="detail-box">
          ...
          <p>
          The expense tracking functionality allows users to manually log their 
          expenses, inputting details like date, amount, category, payment method, 
          and associated notes or receipts. To minimize manual effort, the system 
          enables users to set up recurring expenses, such as rent and utility bills, 
          and automatically log them on a predetermined schedule. This comprehensive 
          expense tracking helps users effortlessly manage their day-to-day spending 
          data.
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <div class="download_box">
              ...
              <div class="btn-box">
                <a href="">
                  <!-- <img src="static\images\Expense-management-1.jpg" alt=""> -->
                </a>
                <a href="">
                  <!-- <img src="static\images\Expense-management-2.jpg" alt=""> -->
                </a>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="box">
        <div class="b-1">
          <div class="client_id">
            <div class="img-box">
              <img src="static\images\MyselfPic.jpg" alt="">
            </div>
            <div class="name">
              <h5>
                Abdul Rehman Irfan
              ...
              <h6>
                Web Front End Development, with +2 years of Exp
              </h6>
            </div>
          </div>
        </div>
        <div class="client_detail">
          <p>
          Skills and expertise in building web applications and websites. 
          This likely includes frontend technologies like HTML, CSS, JavaScript and PHP as well as 
          frontend technologies depending on the projects he has worked on.
          </p>
        </div>
      </div>
      <div class="box">
        <div class="client_id">
          <div class="img-box">
            <img src="static\images\haider.png" alt="">
          </div>
          <div class="name">
            <h5>
              Haider Ali
            ...
            <h6>
              Web Backend Development, Flutter, UI/UX +3years Exp.
            </h6>
          </div>
        </div>
        <div class="client_detail">
          <p>
          Skillset in 3+ years of experience in web backend development. 
          This likely includes skills in server-side technologies, APIs, 
          databases, and building scalable server-side infrastructure.
          </p>
        </div>
      </div>
      <div class="btn-box">
